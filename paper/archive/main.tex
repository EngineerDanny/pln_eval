...
MAC is the strongest secondary predictor: adding it to $N/D$ increases AUC from 0.83 to 0.84, and it provides a visually intuitive summary of inter-taxon dependence strength.
Overdispersion is an additional secondary signal that, when combined with $N/D$, increases AUC further to 0.93.
...
This arXiv version includes the supplementary material referenced in Sections~3 and~4.
The full 28-dataset count-prediction results are also distributed as \path{out/count_prediction_results_full_28.csv}.
