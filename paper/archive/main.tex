...
Figure~\ref{fig:nd_mac_scatter} shows that the sample-to-taxon ratio $N/D$ is the primary determinant of the dataset-level winner, yielding an AUC of 0.938 on its own.
...
MAC is the strongest secondary predictor: adding it to $N/D$ increases AUC from 0.938 to 0.948, and it provides a visually intuitive summary of inter-taxon dependence strength.
...
This interpretation is consistent with the observed AUC of 0.948 obtained from $N/D$ and MAC together, with overdispersion providing further discriminative power.
