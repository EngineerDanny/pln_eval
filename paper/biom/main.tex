...
\author{Daniel Agyapong$^{1,*}$\email{da2343@nau.edu}, Julien Chiquet$^{2}$, Jane Marks$^{3}$, and Toby Dylan Hocking$^{4}$\\
$^{1}$School of Informatics, Computing, and Cyber Systems, Northern Arizona University, Flagstaff, Arizona, U.S.A.\\
$^{2}$UMR MIA Paris-Saclay, Universit\'{e} Paris-Saclay, AgroParisTech, INRAE, Palaiseau, France\\
$^{3}$Department of Biological Sciences, Northern Arizona University, Flagstaff, Arizona, U.S.A.\\
$^{4}$D\'{e}partement d'informatique, Universit\'{e} de Sherbrooke, Sherbrooke, Qu\'{e}bec, Canada}
...
\begin{keywords}
Benchmarking; microbiome; network inference; penalized regression; Poisson log-normal.
\end{keywords}
...
Full dataset metadata, including the representative inventory previously shown in the main manuscript, are provided in Web Table~1 of the Supplementary Material.
...
Dataset-level metadata are provided in Web Table~2 of the Supplementary Material.
...
The complete 28-dataset result table is provided as Web Table~3 in the Supplementary Material and as \texttt{out/count\_prediction\_results\_full\_28.csv} in the repository output.
...
This contrast is shown in Web Figure~1 of the Supplementary Material.
...
Web Tables~1--3 and Web Figure~1 referenced in Sections~3 and~4 are available in the Supplementary Material PDF accompanying this submission.
The full 28-dataset count-prediction results are also distributed as \texttt{out/count\_prediction\_results\_full\_28.csv}.
