...
Web Figure~2 of the Supplementary Material shows that the sample-to-taxon ratio $N/D$ is the primary determinant of the dataset-level winner, yielding an AUC of 0.83 on its own.
...
Web Table~3 reports the complete 28-dataset count-prediction benchmark and highlights the strongest dataset-level contrasts in both directions within the retained benchmark.
The same full result table is also provided as \texttt{out/count\_prediction\_results\_full\_28.csv} in the repository output.
...
Web Tables~1--3 and Web Figures~1--2 referenced in Sections~3 and~4 are available in the Supplementary Material PDF accompanying this submission.
