\documentclass[Review,doublespace,sageh,times]{sagej}
...
\corrauth{Anonymous corresponding author.}
...
Full dataset metadata, including the representative inventory previously shown in the main manuscript, are provided in Table~S2 of the Supplementary Material.
...
Dataset-level metadata are provided in Table~S3 of the Supplementary Material.
...
All experiments were run on an institutional high-performance computing cluster.
...
OMM12 is a defined gut community comprising twelve bacterial taxa, labeled KB1, YL2, KB18, YL27, YL31, YL32, YL44, YL45, I46, I48, I49, and YL58 in Figure~\ref{fig:network_case_omm12}.
...
Across 20 real count datasets and five real interaction-truth benchmarks, neither model class dominates universally.
...
Code availability details are withheld for anonymized peer review.
