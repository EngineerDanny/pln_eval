...
\shorttitle{When Do PLN Models Beat Penalized Poisson Models?}
\shortauthors{Agyapong et~al.}

\title[mode=title]{Understanding When Poisson Log-Normal Models Outperform Penalized Poisson Regression for Microbiome Count Data}
...
\affiliation[1]{organization={School of Informatics, Computing, and Cyber Systems, Northern Arizona University},
                city={Flagstaff},
                state={Arizona},
                country={U.S.A.}}

\affiliation[2]{organization={UMR MIA Paris-Saclay, Universit\'{e} Paris-Saclay, AgroParisTech, INRAE},
                city={Palaiseau},
                country={France}}

\affiliation[3]{organization={Department of Biological Sciences, Northern Arizona University},
                city={Flagstaff},
                state={Arizona},
                country={U.S.A.}}

\affiliation[4]{organization={D\'{e}partement d'informatique, Universit\'{e} de Sherbrooke},
                city={Sherbrooke},
                state={Qu\'{e}bec},
                country={Canada}}
...
\begin{keywords}
Benchmarking \sep microbiome \sep network inference \sep penalized regression \sep Poisson log-normal
\end{keywords}
...
The table includes standard errors computed over LOTO-CV scores, paired $p$-values from LOTO-CV score differences, and Benjamini--Hochberg adjusted $q$-values across the 20 datasets.
...
\begin{figure}[pos=htbp]
  ...
  Each panel reports held-out Poisson deviance (mean $\pm$ SE across LOTO-CV
  scores) for PLN, GLMNet(Poisson), and the featureless baseline.
  The annotated difference and descriptive $p$-value are from paired LOTO-CV
  deviance differences between PLN and GLMNet(Poisson).}
